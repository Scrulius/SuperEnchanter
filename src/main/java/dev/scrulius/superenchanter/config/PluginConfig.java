...
public final class PluginConfig {
    ...
    private void loadAnvilSettings() {
        ...
        anvilBaseXPCost = config.getInt("anvil.base-xp-cost", 250);
        anvilCostPerLevel = config.getInt("anvil.cost-per-enchant-level", 600);
        anvilMaxCost = config.getInt("anvil.max-xp-cost", 15000);
